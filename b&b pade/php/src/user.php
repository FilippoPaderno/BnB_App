...
<body>
   <div class="flex flex-col h-screen">
    ...
    if (isset($_SESSION['username'])) {
        echo "<p class='text-3xl text-base-content font-bold text-center mt-8'>Benvenuto $username</p>";
    } else {
        echo "<p class='text-3xl text-base-content font-bold text-center mt-8'>Benvenuto</p>";
    }
    ?>
