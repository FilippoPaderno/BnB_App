    ...
    <div class="flex flex-col h-screen">
      ...
      <div class="flex flex-col gap-y-2 bg-base-300 p-8 rounded-lg items-center">
        <h1 class="text-5xl font-extrabold text-center text-primary-content mb-8">
          Disdici una prenotazione
        </h1>

        <form action="Disdetta.php" method="post" class="gap-y-4">
          ...
          <div class="flex w-full justify-end mt-4">
            <button type="submit" class="btn btn-accent btn-outline btn-active">Disdici</button>
          </div>
        </form>
        <a href="admin.php">
